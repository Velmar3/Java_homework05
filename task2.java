...
public class task2 {
    public static void main(String[] args) throws Exception {
        ...
        try (BufferedReader br = new BufferedReader(
                new FileReader("D:/Загрузки/1/s/dz/2 четверть/Java/homework5/listEmployees.txt"))) {
            BufferedWriter fw = new BufferedWriter(
                    new FileWriter("D:/Загрузки/1/s/dz/2 четверть/Java/homework5/countNameEmployees.txt"));
